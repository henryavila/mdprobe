...
describe('remote access provider reconciler', () => {
  ...
  it('runs tailscale status and serve with controlled arguments', async () => {
      ...
      if (args[0] === 'status') {
        return {
          stdout: JSON.stringify({
            ...
            Self: { DNSName: 'crcmg005078.bream-goldeye.ts.net.' },
          }),
          stderr: '',
        }
      }
    ...
    expect(result).toMatchObject({
      expose: 'tailscale',
      remoteBaseUrl: 'https://crcmg005078.bream-goldeye.ts.net:8443',
      remoteUrl: 'https://crcmg005078.bream-goldeye.ts.net:8443/spec.md',
      warnings: [],
    })
  })
